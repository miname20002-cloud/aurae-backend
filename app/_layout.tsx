...
function RootLayout() {
  useEffect(() => {
    // SDK 54+ edge-to-edge 기본 활성 → 네비게이션 바가 흰색으로 보이는 버그 방지.
    // "dark" = 어두운 배경에 밝은(흰색) 버튼 아이콘. enforceNavigationBarContrast가
    // false여야 효과 있음 — withNavBarFix.js 플러그인이 styles.xml에서 보장.
